...
class DataPrep():
    ...
    def get_file_paths(self, folder_path, extension):
        file_paths = []
    ...
    def get_audio_segments_wav(self, wav_file_paths):
        audio_segments = []
    ...
    def get_sliced_audo_segments(self, audio_segments, slice_interval, allow_gaps=True):
    ...
    def get_sliced_audio_segments(self, audio_segment, slice_interval, allow_gaps=True):
